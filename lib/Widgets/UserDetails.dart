          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                ProfileInformation(label: 'ID', value: user.id,),
                ProfileInformation(label: 'First Name', value: user.first_name,),
                ProfileInformation(label: 'Middle Name', value: user!.middle_name),
